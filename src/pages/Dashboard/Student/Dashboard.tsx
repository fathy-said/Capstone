...
const mockData = {
  taskStats: {
    completed: { count: 53, percentage: 53, startDate: '20 Nov', endDate: '20 Nov' },
    assigned: { count: 14, percentage: 14, startDate: '20 Nov', endDate: '20 Nov' },
...
const StudentDashboard: React.FC = () => {
  ...
  const { selectedSubjects, dateRange, refreshCount, setSelectedSubjects, setDateRange, refresh } = useStudentDashboardStore();
  ...
  // Project Progress Chart Options
  ...
  const projectProgressSeries = [{
    data: [mockData.projectProgress.currentProgress],
  }];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-600">Track your academic progress and task completion</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 text-center">Project Progress</h3>
          <div className="relative">
            ...
            <div className="w-full bg-gray-200 rounded-full h-6 relative">
              <div 
                ...
                style={{ width: `${mockData.projectProgress.currentProgress}%` }}
              >
