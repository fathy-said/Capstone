      ...
      try {
        ...
        setTimeout(() => {
          ...
          const projectData = {
            ...
            details: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam auctor, nisl eget ultricies aliquam, nunc nisl aliquet nunc, quis aliquam nisl nunc quis nisl. Nullam auctor, nisl eget ultricies aliquam, nunc nisl aliquet nunc, quis aliquam nisl nunc quis nisl.',
            requirements: [
    ...
    <div className="min-h-screen bg-[#F5F7FB] p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mt-1">Supervisor: {project.userName}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody>
                {project.timeline.map((phase: { phase: string, duration: string }, index: number) => (
        ...
        <div className="flex justify-end">
          <button 
            className="bg-[#42A5F5] hover:bg-[#3994e4] text-white px-8 py-3 rounded-md transition duration-200 text-lg font-medium"
          >
